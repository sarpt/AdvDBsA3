...
(
	...
	PositionID           INTEGER NOT NULL ,
	CONSTRAINT R_19 FOREIGN KEY (PositionID) REFERENCES POSITION (PositionID)
)
PARTITION BY REFERENCE(R_19);
...
DATAFILE 'ResIncome.dbf'
SIZE 50M PERMANENT ONLINE;

CREATE TABLESPACE ResOutcome
DATAFILE 'ResOutcome.dbf'
SIZE 50M PERMANENT ONLINE;
